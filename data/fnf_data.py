...
class DatasetFnF(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.min_refscale = opt['min_refscale']
        self.max_refscale = opt['max_refscale']
    ...
    def get_ft3d_fd(self, idx):
        ...
        rgb_flash = rgb * mod_flash(rgb.shape[0], rgb.shape[1])
    ...
    def __getitem__(self, idx):
        ...
        img_pflash_crop = np.concatenate((img_pflash_scale, img_pflash_crop/(16*power+refscale), pattern_norm), axis = 2)
        ...
        return {'L': img_L, 'H': img_H, 'H_path': H_path, 'L_path': L_path, 'N': sigma_map_flash, \
                'F': flash_crop, 'P': pattern_shift, 'D': depth_crop}
